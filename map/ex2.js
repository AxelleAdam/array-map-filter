...
const getFoodCategories = (foods) => {
  return foods.map((something) => {

    if (something.isVegetarian === false) {
      return something.food + " is not suitable for vegetarians";
    } else {

      return something.food + " is suitable for vegetarians";
    }
